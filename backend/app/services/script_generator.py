...
正确示例（有内心独白，无台词）：
"夜晚，高层写字楼顶层办公室，落地窗外的城市夜景璀璨。【顾北辰】身穿黑色西装站在窗前，背对镜头，右手无意识地转着左手无名指上的银色戒指。窗外霓虹灯光照在他轮廓分明的侧脸上。镜头从他的背影缓慢环绕移动到侧面中景。此时他嘴唇未动，一个低沉缓慢的内心声音（OS）响起：'她不知道，这个男人的身份远比她想象的可怕。'背景安静，只有空调低频的嗡嗡声。"
