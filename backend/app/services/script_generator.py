...
- 反派必须极端可恨：言语粗俗、行为粗鄙、得意时自爆阴谋、施虐时享受快感
- 每个反派都要有具体的恶行细节（踩脸、扇巴掌、撕衣服、泼水），不能抽象概括

【冲突升级模式】（每集至少使用2-3层，逐层升级）
...
要求：一集之内冲突要从低层往高层递进，反派的行为要越来越极端。

【"压-爽"节奏单元】（每集至少2个循环）
每一集至少2个"压-爽"小循环，情绪要反复拉扯：
- 压抑时间占60-70%，释放瞬间占30-40%
- 要"压→小爽→再压→大爽"的螺旋上升
- 每次反派施压都要比上一次更狠
- 主角反击要干脆利落，一句话或一个动作就完成反转

【剧情推进节奏】（必须快！每集至少3-5个剧情转折点）
- 通过对话快速揭露真相、推进事件，不要用旁白代替本该用台词表达的内容
- 每个场景都要推进剧情，不能有"过渡性"的废场景
- 背景信息通过对话带出（最主要方式），不要大段旁白介绍

【旁白技法】（核心叙事手段，必须大量使用）
短剧中旁白（画外音/OS）是推动叙事的第一手段，比纯对话效率更高。每集至少30%-50%的叙事量由旁白承担。

旁白三大类型：
一、内心独白（OS）：角色内心想法，配合角色表情特写
  - 例："她不知道，这个决定将改变一切"
  - 例："我发誓，这辈子不会再让任何人欺负我"
  - 用途：展示角色心理活动、制造信息差、增强代入感

二、解说旁白：第三人称叙事，交代背景、时间流逝、人物关系
  - 例："三年前，她还是苏家最受宠的千金"
  - 例："所有人都以为她死了，但她回来了"
  - 用途：快速交代前情、跳过无关时间、压缩叙事

三、回忆旁白：配合闪回画面，角色回忆往事
  - 例："那个雨夜，母亲临终前说的话还回荡在耳边"
  - 用途：情感铺垫、伏笔回收、身份揭露

【旁白使用规则】
- 开场必须有旁白：用旁白在3秒内交代核心矛盾（"她重生了，回到了被陷害的那一天"）
- 转场必用旁白：场景切换时用旁白交代时间/地点变化
- 情绪高潮用内心独白：展示角色心理活动，增强共情
- 信息交代用解说旁白：比对话更高效，避免角色"尬聊"交代背景
- 集末钩子用旁白强化：配合悬念画面，旁白说出暗示性台词

【信息释放策略】
- 三层信息差：观众知道而角色不知道（上帝视角）、角色知道而观众不知道（悬念）、反派知道而主角不知道（危机感）
- 背景信息植入：旁白解说（最高效）、对话带出、闪回配合旁白
...
【对白要求】（台词是短剧的灵魂）
- 每集台词量600-900字，至少60%镜头有台词
- 台词简短有力，每句只抛一个信息
- 口语化接地气，不秀文笔
- 每句台词必须有功能：推动剧情/压情绪/展信息/塑人物/造钩子
- 反派台词越粗俗难听越好，反派得意时必须主动揭露阴谋
- 台词要密集推进剧情：通过对话快速揭露真相、推进事件、制造冲突
- 高频台词模式：侮辱施压型、反转型、身份揭露型、情感拉扯型
- 旁白量300-500字，至少40%镜头有旁白
...
【"压-爽"节奏单元】（每集必须包含至少2个循环）
每一集内部必须包含至少2个"压-爽"小循环，情绪要反复拉扯：
- 压（情绪低点）：反派施压，主角受辱——压抑时间要长，层层递进，让观众憋屈到极点
- 爽（情绪释放）：主角反击、男主救场、身份揭露——释放瞬间要短而强烈，一句话反转
关键规则：
1. 压抑的时间必须长（占60-70%篇幅），释放的瞬间必须短而强烈（占30-40%）
2. 不能一次爽完就结束，要"压→小爽→再压→大爽"的螺旋上升
3. 每次反派施压都要比上一次更狠、更极端
4. 主角反击要干脆利落，一句话或一个动作就完成反转

【冲突升级五层递进】（每集至少使用2-3层，逐层升级）
第一层：言语侮辱（贬低身份、地位、能力）——"废物""贱种""你也配？"
第二层：肢体暴力/权力碾压（扇耳光、推搡、踩脸、限制人身自由）
第三层：关系破坏（离间主角与亲人/爱人的关系，诬陷栽赃）
第四层：经济/生存威胁（剥夺财产、制造债务、断绝生路）
第五层：生命威胁（绑架、下毒、制造事故、直接下死手）
要求：一集之内冲突要从低层往高层递进，不要停留在同一层。反派的行为要越来越极端，让观众的愤怒不断累积。
...
- 每个场景都要推进剧情，不能有"过渡性"的废场景
- 背景信息通过对话带出（最主要方式），不要大段旁白介绍
- 身份揭露要分阶段，每次快揭露时都要有反转
- 信息差运用：观众知道而角色不知道（制造期待感）、角色知道而观众不知道（维持悬念）

【旁白核心要求】（旁白是短剧叙事的第一手段）
- 每集至少40%-60%的镜头需要旁白，旁白总量应达到300-500字
- 旁白三大类型必须全部使用：
  1. 内心独白（OS）：角色内心想法，配合特写镜头。例："她不知道，这个男人的身份远比她想象的可怕"
  2. 解说旁白：第三人称叙事，交代背景/时间跳转/关系说明。例："三年前，她还是苏家最受宠的千金"
  3. 回忆旁白：配合闪回画面。例："那个雨夜，母亲的话还在耳边回响"
- 旁白必须口语化，像跟观众聊天，不能书面化
- 旁白的功能：快速推进叙事、制造信息差、增强情绪感染力、交代角色心理
- 旁白要密集：不要只在某几个镜头放旁白，要均匀分布在全集各处

【台词核心要求】（台词是短剧的灵魂，必须密集）
- 每集总台词量必须达到600-900字，这是硬性指标！台词必须占全集内容的主体
- 至少60%的镜头必须有台词，对话镜头越多越好
- 每个对话镜头可以有多句台词（2-4句），不要每个镜头只写一句
- 台词必须简短有力，一句话只抛出一个信息
- 每句台词必须至少满足以下一种功能：
  1. 推动剧情（揭露真相、推进事件、交代关键信息）
  2. 压情绪（侮辱施压、制造冲突、贬低打压）
  3. 展现背景信息（通过对话交代人物关系、过往恩怨）
  4. 塑造人物（体现角色性格、立场、情绪变化）
  5. 制造钩子（制造悬念、抛出疑问）
- 台词要密集推进剧情：通过对话快速揭露真相、推进事件、制造冲突，不要用旁白代替本该用台词表达的内容
- 反派台词要狠毒粗俗，主动揭露阴谋，让观众恨得牙痒痒
- 配角台词也要有信息量，不要写废话
...
反派行为要求：
- 反派出手要狠、要绝，不能心慈手软
- 反派要主动挑衅、主动制造冲突，不能被动等待
- 反派被打脸后不服气，要找更强大的靠山继续报复（套娃式升级）
- 反派的恶行要有具体细节，不能抽象概括（"将反派赶走"❌ → "一脚踹在她脸上"✓）
- 反派在施压时要越说越兴奋，享受施虐的快感
...
【AI绘图提示词要求】（极其重要！）
- 必须全部使用中文，禁止出现任何英文单词或短语
- 必须是完整的自然语言段落，像导演给摄影师的口述指令，绝对不能用逗号拼接关键词
- 禁止使用"8k""高清""wideshot""masterpiece""best quality"等中英文参数词
- 每个镜头的ai_prompt应是一段完整的、有画面感的中文自然语言描述，至少50字

正确示例：
"暴雨夜的城市街道，刺眼的卡车大灯迎面照射而来。一个身穿外卖员制服的年轻男子倒在积水中，鲜血在雨水中晕开，头部戴着一个黄色的现代外卖头盔。强烈的逆光，冷色调，画面极具视觉冲击力。"

错误示例（绝对不能这样写）：
"1boy,外卖员,黄色头盔,暴雨,血液,8k,高清,逆光,冷色调,masterpiece,best quality"
  ...
  "shots": [
    {
      ...
      "dialogue": "台词（含情绪标注，每个镜头可包含2-4句对话，用换行分隔不同角色的台词）",
      "narration": "旁白/画外音（内心独白、解说旁白、回忆旁白，约40%-60%的镜头需要旁白）",
      "sound_effects": "音效描述",
      "bgm_suggestion": "背景音乐建议",
      "duration": 3.0,
      "ai_prompt": "AI绘图提示词（必须全中文，用自然语言段落描述画面，像导演给摄影师的口述指令）",
...
3. 台词口语化、有网感，台词量必须达到600-900字，至少60%镜头有台词
4. 旁白量必须达到300-500字，至少40%镜头有旁白
5. 结尾是悬念
6. 与前几集保持剧情连贯
7. ai_prompt使用自然语言段落描述画面，不要使用逗号拼接关键词
8. 如果知识库上下文中包含"本集必须包含的原著钩子"，请在对应分镜的hook_type和hook_detail中标记这些钩子
9. total_duration必须等于所有分镜duration之和，且必须达到{request.episode_duration}秒的目标时长
10. 剧情推进要快：每集至少3-5个剧情转折点，通过对话快速揭露信息，不要拖节奏"""
