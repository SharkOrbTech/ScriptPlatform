...
【"压-爽"节奏单元】
每一集至少一个"压-爽"小循环：压抑的时间要长，释放的瞬间要短而强烈。
...
- 爽（情绪释放）：主角反击、男主救场、身份揭露——释放瞬间要短而强烈
...
【台词核心要求】
- 每集总台词量300-400字，旁白量200-300字，台词+旁白共同推动叙事
- 台词必须简短有力，一句话只抛出一个信息
- 不能让一个人物长篇幅自说自话
- 不能大段堆砌台词
- 每句台词必须至少满足以下一种功能：
  ...
  "shots": [
    {
      ...
      "dialogue": "台词（含情绪标注）",
      "narration": "旁白/画外音（内心独白、解说旁白、回忆旁白，约30-50%的镜头需要旁白）",
      "sound_effects": "音效描述",
