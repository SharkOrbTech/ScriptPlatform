...
B. 身份反转开场：开场即展示核心矛盾（前世结局→重生→改变命运）
  ⚠ 禁止"我重生了""我穿越回了……"式旁白开场。用具体场景展示重生/穿越，不要让角色用台词或OS直接说出来。观众看到主角睁开眼、发现自己回到了过去的某个关键时刻，这就够了——不需要让角色念出来
...
- 使用规则：
  ...
  - 禁止"我重生了""我穿越回了""上一世我……"式开场旁白。重生/穿越设定通过场景动作展示，不要让角色念出来
  - 台词是叙事的核心驱动力
...
- 一集最多1-2处内心独白，放在情感最关键的时刻。如果旁白在某个镜头中显得生硬，直接省略
- 禁止"我重生了""我穿越回了"式开场旁白。重生/穿越设定用场景展示，不要让角色念出来
- 同一镜头中旁白和台词互斥，只能出现一个
...
- ⚠ 首集禁止"我重生了""我穿越回了……"式旁白开场。用场景开场：主角从噩梦中惊醒/睁开眼发现回到了过去/看到熟悉又陌生的环境——展示，不叙述
