...
- 第1集信息密度要最高，后续集可以适当放缓做情感铺垫

【旁白技法】（核心叙事手段）
短剧中旁白（画外音/OS）是推动叙事的第一手段，比纯对话效率更高。每集旁白量300-500字。
...
【对白要求】（台词是短剧的灵魂）
- 每集台词量600-900字，第1集台词要最多最密（抓人），后续集可以根据剧情需要调整
- 台词简短有力，每句只抛一个信息
- 口语化接地气，不秀文笔
...
- 爽（情绪释放）：主角反击、身份揭露——释放瞬间要短而强烈，一句话反转
关键规则：
...
要求：冲突要逐层递进，反派的行为要越来越极端，让观众的愤怒不断累积。不必每集都用满五层，根据剧情需要选择。
